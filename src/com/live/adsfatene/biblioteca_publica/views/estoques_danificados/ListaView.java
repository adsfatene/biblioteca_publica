...
import com.live.adsfatene.biblioteca_publica.controllers.EstoquesDanificadosController;
...
public class ListaView extends javax.swing.JPanel {
    ...
    private final EstoquesDanificadosController estoquesDanificadosController;
    ...
    public ListaView(EstoquesDanificadosController estoquesDanificadosController) {
        initComponents();
        this.estoquesDanificadosController = estoquesDanificadosController;
    ...
    private void jToggleButtonCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonCadastroActionPerformed
        estoquesDanificadosController.cadastrar();
    ...
    private void jToggleButtonFiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonFiltroActionPerformed
        estoquesDanificadosController.filtrar(new EstoqueDanificado());
    ...
    private void jToggleButtonEdicaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButtonEdicaoActionPerformed
        if (jTableLista.getSelectedRowCount() > 0) {
            estoquesDanificadosController.editar((EstoqueDanificado) jTableLista.getValueAt(jTableLista.getSelectedRow(), 0));
        } else {
    ...
    private void jTableListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableListaMouseClicked
        if (jToolBarAcoes.isEnabled() && evt.getClickCount() == 2 && evt.getButton() == MouseEvent.BUTTON1) {
            EstoqueDanificado estoqueDanificado = (EstoqueDanificado) jTableLista.getValueAt(jTableLista.getSelectedRow(), 0);
            if (jToggleButtonEdicao.isSelected()) {
                estoquesDanificadosController.editar(estoqueDanificado);
            } else {
                estoquesDanificadosController.exibir(estoqueDanificado);
            }
        }
    ...
    public EstoquesDanificadosController getEstoquesDanificadosController() {
        return estoquesDanificadosController;
    }
    ...
    public void habilitar(boolean aFlag){
        ...
        estoquesDanificadosController.getAplicacaoController().getAplicacaoView().habilitar(aFlag);
    }
}