...
public class ExibicaoView extends javax.swing.JDialog {
    ...
    public void atualizar(Estoque estoque) {
        jTextFieldCodigo.setText(estoque.getMaterial().getCodigo().toString());
        jTextFieldTitulo.setText(estoque.getMaterial().getDadoMaterial().getTitulo());
        jTextFieldDescricao.setText(estoque.getMaterial().getDadoMaterial().getDescricao());
        jTextFieldEdicao.setText(estoque.getMaterial().getDadoMaterial().getEdicao().toString());
        jTextFieldAnoPublicacao.setText(estoque.getMaterial().getDadoMaterial().getAnoPublicacao().toString());
        jTextFieldEditora.setText(estoque.getMaterial().getDadoMaterial().getEditora().getNome());
        jTextFieldCategoria.setText(estoque.getMaterial().getDadoMaterial().getCategoria().getNome());
